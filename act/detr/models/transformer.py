...
class Transformer(nn.Module):
    ...
    def forward(self, query_embed,
        ...
        src_list = [latent_input, img_src, robot_state_src]
        pos_list = [latent_pos, img_pos, robot_state_pos]
        pad_list = [latent_is_pad, img_src_is_pad, robot_state_is_pad]

        # print("latent_input:", latent_input.shape)
        # print("img_src:", img_src.shape)
        # print("robot_state_src:", robot_state_src.shape)
        src = torch.cat(src_list, dim=0)

        # print("latent_pos.shape:", latent_pos.shape)
        # print("img_pos.shape:", img_pos.shape)
        # print("robot_pos.shape:", robot_state_pos.shape)
        pos = torch.cat(pos_list, dim=0)

        # is_pad = torch.cat(pad_list, dim=1)
        is_pad = None
